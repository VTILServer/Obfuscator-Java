...
public class CompilerOptions {
    ...
    private final LinkedList<String> stringsCache = new LinkedList<>();
    private final LinkedList<String> chunkDataOrder = new LinkedList<>();
    private final ArrayList<String> opCodeNames = new ArrayList<>();
    private final ArrayList<Integer> usedOpcodes = new ArrayList<>();
    private final LinkedList<Integer> luaP_opmodes = new LinkedList<>();
    ...
    public String patchTemplate(String template) {
        ...
        template = template.replaceAll("%%STRING1%%", generateCustomString("better than PSU"));
        template = template.replaceAll("%%STRING2%%", generateCustomString("|"));
        template = template.replaceAll("%%STRING3%%", generateCustomString("Bad psu"));
        ...
        template = template.replaceAll("%%STRING7%%", generateCustomString("Xell"));
        ...
        template = template.replaceAll("%%STRING10%%", generateCustomString("Xell bytecode expected."));
        template = template.replaceAll("%%STRING11%%", generateCustomString("\\27XEL"));
